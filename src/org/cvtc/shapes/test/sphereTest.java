...
public class sphereTest {
	...
	public void testSurfaceArea() {
		Sphere sphere1 = new Sphere(new MessageBoxSub(), 5);
	...
	public void testSurfaceArea2() {
		Sphere sphere2 = new Sphere(new MessageBoxSub(), 10);
	...
	public void testSurfaceArea3() {
		Sphere sphere3 = new Sphere(new MessageBoxSub(), 1);
	...
	public void testNegativeGetRadius() {
		Sphere sphere1 = new Sphere(new MessageBoxSub(), -1);
		sphere1.getRadius();
	}
