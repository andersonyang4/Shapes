...
public class cylinderTest {
	...
	public void testSurfaceArea() {
		Cylinder cylinder1 = new Cylinder(new MessageBoxSub(), 4, 23);
	...
	public void testSurfaceArea2() {
		Cylinder cylinder2 = new Cylinder(new MessageBoxSub(), 1, 5);
	...
	public void testSurfaceAre3() {
		Cylinder cylinder3 = new Cylinder(new MessageBoxSub(), 4, 2);
	...
	public void testGetRadius() {
		Cylinder cylinder1 = new Cylinder(new MessageBoxSub(), 1, 2);
